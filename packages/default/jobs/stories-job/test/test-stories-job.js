/**
 * Test file for Job: stories-job
 */

var assert = require ('assert');
var stories_job_SUT = require('../stories-job');

var mockedConfig, mockedDependencies;

describe ('stories-job test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      stories_job_SUT.onRun(config, mockedDependencies, function(err, data){
