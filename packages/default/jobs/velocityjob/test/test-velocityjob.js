/**
 * Test file for Job: velocityjob
 */

var assert = require ('assert');
var velocityjob_SUT = require('../velocityjob');

var mockedConfig, mockedDependencies;

describe ('velocityjob test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      velocityjob_SUT.onRun(config, mockedDependencies, function(err, data){
