/**
 * Test file for Job: bugs-job
 */

var assert = require ('assert');
var bugs_job_SUT = require('../bugs-job');

var mockedConfig, mockedDependencies;

describe ('bugs-job test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      bugs_job_SUT.onRun(config, mockedDependencies, function(err, data){
