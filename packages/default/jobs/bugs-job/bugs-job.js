...
module.exports = {
  ...
  onRun: function (config, dependencies, jobCallback) {
    ...
    /*
     ...
     It is a good idea to cover this with unit tests as well (see test/bugs-job file)
     ...
     Have a look at test/bugs-job for an example of how to unit tests this easily by mocking easyRequest calls
    ...
    dependencies.easyRequest.HTML(config.fullRequest, function (err, html) {
    	if(!err){
    		...
    		console.log("Error in bugs-job request");
    	}
    });
  }
};